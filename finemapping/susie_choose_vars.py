...
def load_gts(readme_fname, outcols_fname, phenotype, chrom, start_pos, end_pos):
...
if __name__ == '__main__':
    ...
    load_gts(args.readme, args.outcols, args.phenotype, args.chrom, args.start, args.end)

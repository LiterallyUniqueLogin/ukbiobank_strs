Considering all variants from input files signals/peak_inputs/aspartate_aminotransferase_str_5e-9.tab and signals/peak_inputs/aspartate_aminotransferase_imputed_snp_5e-9.tab

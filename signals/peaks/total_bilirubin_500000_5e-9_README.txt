Considering all variants from input files signals/peak_inputs/total_bilirubin_str_5e-9.tab and signals/peak_inputs/total_bilirubin_imputed_snp_5e-9.tab

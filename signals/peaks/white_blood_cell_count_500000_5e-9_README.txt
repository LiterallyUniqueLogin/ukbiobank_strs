Considering all variants from input files signals/peak_inputs/white_blood_cell_count_str_5e-9.tab and signals/peak_inputs/white_blood_cell_count_imputed_snp_5e-9.tab

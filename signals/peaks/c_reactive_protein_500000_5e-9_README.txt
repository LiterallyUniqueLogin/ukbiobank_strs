Considering all variants from input files signals/peak_inputs/c_reactive_protein_str_5e-9.tab and signals/peak_inputs/c_reactive_protein_imputed_snp_5e-9.tab

...
Subsetting to samples at sample_qc/subpop_runs/BCL2L11_len_29/white_brits/no_phenotype/combined.sample
...
Dropping 12 samples whose first (non yet dropped) data recording for this phenotype occurred on assessment 1 because that is less than 50 total samples.
Dropping 3 samples whose first (non yet dropped) data recording for this phenotype occurred on assessment 2 because that is less than 50 total samples.

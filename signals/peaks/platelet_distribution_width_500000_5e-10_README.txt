Considering all variants from input files signals/peak_inputs/platelet_distribution_width_str_5e-10.tab and signals/peak_inputs/platelet_distribution_width_imputed_snp_5e-10.tab

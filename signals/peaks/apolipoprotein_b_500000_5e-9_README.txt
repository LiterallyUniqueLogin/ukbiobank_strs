Considering all variants from input files signals/peak_inputs/apolipoprotein_b_str_5e-9.tab and signals/peak_inputs/apolipoprotein_b_imputed_snp_5e-9.tab

Considering all variants from input files association/results/total_protein/my_str/results.tab and association/results/total_protein/plink_snp/results.tab

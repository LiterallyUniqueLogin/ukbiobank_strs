Considering all variants from input files signals/peak_inputs/alkaline_phosphatase_str_5e-9.tab and signals/peak_inputs/alkaline_phosphatase_imputed_snp_5e-9.tab

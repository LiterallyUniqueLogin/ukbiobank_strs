Considering all variants from input files association/results/cholesterol/my_str/results.tab and association/results/cholesterol/plink_snp/results.tab

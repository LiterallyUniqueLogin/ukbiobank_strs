Considering all variants from input files signals/peak_inputs/ldl_cholesterol_direct_str_5e-9.tab and signals/peak_inputs/ldl_cholesterol_direct_imputed_snp_5e-9.tab

Considering all variants from input files signals/peak_inputs/mean_corpuscular_haemoglobin_str_5e-10.tab and signals/peak_inputs/mean_corpuscular_haemoglobin_imputed_snp_5e-10.tab

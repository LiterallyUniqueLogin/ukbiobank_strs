...
Subsetting to samples at sample_qc/subpop_runs/BCL2L11_len_21/white_brits/no_phenotype/combined.sample
...
Dropping 22 samples whose first (non yet dropped) data recording for this phenotype occurred on assessment 1 because that is less than 50 total samples.
Dropping 0 samples whose first (non yet dropped) data recording for this phenotype occurred on assessment 2 because that is less than 50 total samples.

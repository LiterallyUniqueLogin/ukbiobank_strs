Any STR x phenotype association that has p-value <= 1e-10 and either FINEMAP posterior probability of causality >= 0.8 or SuSiE CS posterior probability of causality >= 0.33
phenotype
chrom
...
SuSiE_pcausal - SuSiE's posterior probability of causality, accumulated across all credible sets in the region.
SuSiE_CS_pcausal - SuSiE's posterior probability of causality, from the single credible set this variant was identified in.

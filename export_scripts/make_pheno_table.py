...
def generate_phenotypes_table(all_phenotypes):
    with open(f'{ukb}/export/combined/phenotypes.tab', 'w') as outfile:
        outfile.write(
            'phenotype\t'
            'data_field_ID\t'
            'measurement_units\t'
    ...
    with open(f'{ukb}/export/combined/phenotypes_README.txt', 'w') as readme:
        ...
        readme.write('TODO: is it important to report the number of individuals before '
                     'subsetting to unrelated ones?\n')

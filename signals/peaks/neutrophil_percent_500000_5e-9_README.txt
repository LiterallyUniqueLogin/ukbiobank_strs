Considering all variants from input files signals/peak_inputs/neutrophil_percent_str_5e-9.tab and signals/peak_inputs/neutrophil_percent_imputed_snp_5e-9.tab

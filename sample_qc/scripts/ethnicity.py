...
white_brits = polars.read_csv(args.white_brits_sample_fname, sep=' ', new_columns = ['id'])
ethnicities = polars.read_csv(args.ethnicity_fname, sep='\t', dtype={'eid': int})
...
for col in response_cols[1:]:
    ethnicities = ethnicities.with_column(polars

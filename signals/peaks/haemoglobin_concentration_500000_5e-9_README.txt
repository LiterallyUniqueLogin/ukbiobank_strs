Considering all variants from input files signals/peak_inputs/haemoglobin_concentration_str_5e-9.tab and signals/peak_inputs/haemoglobin_concentration_imputed_snp_5e-9.tab

Considering all variants from input files association/results/platelet_crit/my_str/results.tab and association/results/platelet_crit/plink_snp/results.tab

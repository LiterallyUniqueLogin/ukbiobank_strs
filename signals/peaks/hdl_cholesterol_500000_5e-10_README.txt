Considering all variants from input files signals/peak_inputs/hdl_cholesterol_str_5e-10.tab and signals/peak_inputs/hdl_cholesterol_imputed_snp_5e-10.tab

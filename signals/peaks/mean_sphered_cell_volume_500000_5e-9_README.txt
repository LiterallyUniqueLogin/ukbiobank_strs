Considering all variants from input files signals/peak_inputs/mean_sphered_cell_volume_str_5e-9.tab and signals/peak_inputs/mean_sphered_cell_volume_imputed_snp_5e-9.tab
